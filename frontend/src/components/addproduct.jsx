    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
            <div className="bg-white  rounded-lg p-6 w-[70%]">
                <h2 className="text-2xl  text-h1 font-bold mb-4">Add New Product</h2>
                <form onSubmit={handleSubmit} className="grid grid-cols-3 gap-4">
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            className="w-full border border-slate-200 px-3 py-2 text-text text-text  rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                            required
                        />
                    </div>
                    <div className="mb-4">
